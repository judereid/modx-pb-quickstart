 ...
 * @package setup
 */
class modInstallPagodaRequest extends modInstallRequest {
    ...
    public function handle($action = '') {
        ...
        // $results= $this->install->test($mode, 'test.modInstallTestPagoda');
        ...
        /* Run installer */
        $this->install->getService('runner','runner.modInstallRunnerPagoda');
        $failed = true;
        $errors = array();
